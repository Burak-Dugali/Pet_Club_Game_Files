...
public class WarScript5 : MonoBehaviour
{
    ...
    void Dusmanswitch()
    {
        switch (savas)
        {
            case 1:
                ...
                if (DayanıklılıkGameScript.anaekran >= 35 && Ceviklikgamescript.cevanaekran >= 30 && GucGameScript.gucanapuan >= 30)
                {
            ...
            case 2:
                ...
                dusmanskiltext4.SetActive(false);
                dusmanskiltext5.SetActive(false);
                if (DayanıklılıkGameScript.anaekran >= 30 && Ceviklikgamescript.cevanaekran >= 35 && GucGameScript.gucanapuan >= 30)
                {
            ...
            case 3:
                ...
                if (DayanıklılıkGameScript.anaekran >= 35 && Ceviklikgamescript.cevanaekran >= 25 && GucGameScript.gucanapuan >= 35)
                {
