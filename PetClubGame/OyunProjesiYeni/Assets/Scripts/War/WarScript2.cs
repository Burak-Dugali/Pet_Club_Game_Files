...
public class WarScript2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Debug.Log(Warbirdusmancan.dusmancan);
    ...
    void Dusmanswitch()
    {
        switch (savas)
        {
            case 1:
                ...
                if (DayanıklılıkGameScript.anaekran>=10 && Ceviklikgamescript.cevanaekran >= 10 && GucGameScript.gucanapuan >= 10)
                {
