...
public class WarScript3 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log(YemekScript.yemekdegeri);
    ...
    void Dusmanswitch()
    {
        switch (savas)
        {
            case 1:
                ...
                if (DayanıklılıkGameScript.anaekran >= 20 && Ceviklikgamescript.cevanaekran >= 15 && GucGameScript.gucanapuan >= 15)
                {
            ...
            case 2:
                ...
                dusmanskiltext4.SetActive(false);
                dusmanskiltext5.SetActive(false);
                if (DayanıklılıkGameScript.anaekran >= 20 && Ceviklikgamescript.cevanaekran >= 20 && GucGameScript.gucanapuan >= 20)
                {
            ...
            case 5:
                ...
                savas = 0;
                if (DayanıklılıkGameScript.anaekran >= 15 && Ceviklikgamescript.cevanaekran >= 20 && GucGameScript.gucanapuan >= 20)
                {
